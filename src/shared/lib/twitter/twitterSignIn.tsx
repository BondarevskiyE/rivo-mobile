...
const CONSUMER_KEY = '7zuwswZTFSw8Nj1cVNiWM33rl';
const CONSUMER_SECRET = 'nTk4XLmrV1oIOaYojQzEmqNrLj1VRZjc4Med2uwd2emR9z2ja3';
const TWITTER_API = 'https://api.twitter.com';
const OAUTH_CALLBACK_URL = 'com.rivomobile://';
