...
// export type CreateKernelAccountClientReturnType = ReturnType<
//   typeof createKernelAccountClient<Transport, Chain, KernelSmartAccount>
// >;
...
//   async sendSimulatedUserOperation(
//     kernelClient: CreateKernelAccountClientReturnType,
...
//   async serializeSessionKeyKernelClient(
//     kernelAccount: KernelSmartAccount,
...
//     mode: WebAuthnMode,
//   ) {
//     const rootModularPermissionPlugin =
//       await this.createPasskeyRootModularPermissionPlugin(
//         publicClient,
//         passkeyName,
//         mode,
//       );
...
//         mode,
//       );
//     const sessionKeyModularPermissionPlugin =
//       await this.createSessionKeyModularPermissionPlugin(
//         publicClient,
//         sessionPrivateKey,
//         policies,
//       );
...
//             getAbiItem({abi: KernelAccountAbi, name: 'executeBatch'}),
//           ),
//         },
//       },
//     });
...
//   private async createEoaRootModularPermissionPlugin(
//     publicClient: PublicClient,
...
//   ) {
//     const rootModularPermissionPlugin =
//       await this.createEoaRootModularPermissionPlugin(
//         publicClient,
//         walletClient,
//       );
//     const sessionKeyModularPermissionPlugin =
...
//     chain: Chain,
//   ) {
//     const sessionKeyAccount = await deserializeModularPermissionAccount(
//       publicClient,
