...
type Props = StackScreenProps<HomeStackProps, HOME_SCREENS.SELL_SCREEN>;

export const SellScreen: React.FC<Props> = ({navigation}) => {
        ...
        <View style={styles.dragContainer}>
          <DragUpFromBottom
            ...
            <TransakWidget
              ...
              widgetType={TRANSAK_WIDGET_TYPE.SELL}
            />
          </DragUpFromBottom>
        </View>
      </SafeAreaView>
